...
require_game_build(3179)
RecoveryScript = menu.add_submenu("【 S 】 Recovery Script v1.68   ")
...
function SpawnVehicle(Hash)
	...
	globals.set_int(RNVS + 47, Hash)
	globals.set_float(RNVS + 43, pos.x+2)
	globals.set_float(RNVS + 44, pos.y)
	globals.set_float(RNVS + 45, pos.z)
	globals.set_boolean(RNVS + 42, true)
    sleep(0.5)
 end
...
BankE:add_action("◀◀ On Event Maze Bank Shootout", function() 
    ...
    globals.set_int(262145 + 34270, 1000) 
end)
BankE:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
stats.set_int(MPX .. "VCM_FLOW_PROGRESS", 1048576) 
stats.set_int(MPX .. "VCM_STORY_PROGRESS", -1) end)

StoryMissions:add_action("◀◀ House Keeping", function() 
stats.set_int(MPX .. "VCM_FLOW_PROGRESS",1310785)
stats.set_int(MPX .. "VCM_STORY_PROGRESS", -1) end)

StoryMissions:add_action("◀◀ Strong Arm Tactics", function() 
stats.set_int(MPX .. "VCM_FLOW_PROGRESS", 1310915)
stats.set_int(MPX .. "VCM_STORY_PROGRESS", -1) end)

StoryMissions:add_action("◀◀ Play to Win", function() 
stats.set_int(MPX .. "VCM_FLOW_PROGRESS", 1311175)
stats.set_int(MPX .. "VCM_STORY_PROGRESS", -1) end)
...
stats.set_int(MPX .. "VCM_FLOW_PROGRESS", 1312735)
stats.set_int(MPX .. "VCM_STORY_PROGRESS", -1) end)
...
SkipContract:add_action("◀◀ Set Up Dre Finale Mission", function()
			PlayerIndex = globals.get_int(R001)
...
AutoShopPreps1:add_array_item("◀◀ Set Skip", {"The Union Depository", "The Superdollar Deal", "The Bank Contract", "The ECU Job", "The Prison Contract", "The Agency Deal", "The Lost Contract", "The Data Contract"}, function() return xox_18 end, function(value)
 if value == 1 then stats.set_int(mpx .. "TUNER_GEN_BS", R003) stats.set_int(mpx .. "TUNER_CURRENT", 0) 
elseif value == 2 then stats.set_int(mpx .. "TUNER_GEN_BS", R004) stats.set_int(mpx .. "TUNER_CURRENT", 1) 
elseif value == 3 then stats.set_int(mpx .. "TUNER_GEN_BS", R003) stats.set_int(mpx .. "TUNER_CURRENT", 2) 
elseif value == 4 then stats.set_int(mpx .. "TUNER_GEN_BS", R003) stats.set_int(mpx .. "TUNER_CURRENT", 3) 
elseif value == 5 then stats.set_int(mpx .. "TUNER_GEN_BS", R003) stats.set_int(mpx .. "TUNER_CURRENT", 4) 
elseif value == 6 then stats.set_int(mpx .. "TUNER_GEN_BS", R003) stats.set_int(mpx .. "TUNER_CURRENT", 5) 
elseif value == 7 then stats.set_int(mpx .. "TUNER_GEN_BS", R003) stats.set_int(mpx .. "TUNER_CURRENT", 6) 
else stats.set_int(mpx .. "TUNER_GEN_BS", R003) stats.set_int(mpx .. "TUNER_CURRENT", 7) end xox_18 = value end) 
...
Salvage1:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
Salvage1:add_int_range("◀ Set Money ", 3000, 0, 3500000, function()  return globals.get_int(262145 +36063 ) end, function(value) globals.set_int(262145 +36063, value) end)
...
Heists = Online:add_submenu("⫸ Heists")
...
X64115888:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)

X64115888:add_action("◀◀ Bypass Fleeca Hack", function() fmC:set_int(R007, 7) end) 
X64115888:add_action("◀◀ Quick Fleeca Drill", function() fmC:set_float(R008, 100) end)  


X64115888:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)

X64115 =X6411:add_submenu("⫸ Cuts $ Apartmen")
X64115:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)

X64115:add_int_range("◀ Player 1", 1.0, 15, 100, function() return globals.get_int(CP1Ap) end, function(value) globals.set_int(CP1Ap, value) end) 
X64115:add_int_range("◀ Player 2", 1.0, 15, 100, function() return globals.get_int(CP2Ap) end, function(value) globals.set_int(CP2Ap, value) end) 
X64115:add_int_range("◀ Player 3", 1.0, 15, 100, function() return globals.get_int(CP3Ap) end, function(value) globals.set_int(CP3Ap, value) end)
X64115:add_int_range("◀ Player 4", 1.0, 15, 100, function() return globals.get_int(CP4Ap) end, function(value) globals.set_int(CP4Ap, value) end) 

X64115:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
X64115:add_action("◀ All 200", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 200) end end)
X64115:add_action("◀ All 179", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 179) end end)
X64115:add_action("◀ All 150", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 150) end end)
X64115:add_action("◀ All 120", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 120) end end)
X64115:add_action("◀ All 100", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 100) end end)
X64115:add_action("◀ All 85", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 85) end end)
X64115:add_action("◀ All 75", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 75) end end)
X64115:add_action("◀ All 50", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 50) end end)
X64115:add_action("◀ All 25", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 25) end end)
X64115:add_action("◀ All 0", function() for i = CP1Ap, CP4Ap do globals.set_int(i, 0) end end)
X64115:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)

X64116 =X6411:add_submenu("⫸ Get Money $M")
X64116:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
X64116:add_action("✅ Get Money 14 Million -( Normal Heist ) ", function() end)
X64116:add_action("  You can do the task twice every 24 hours", function() end)
X64116:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
X64116:add_int_range("◀ %6900 = 14 Million ", 6900, 6900, 6900, function() return globals.get_int(CP1Ap) end, function(value) globals.set_int(CP1Ap, value) end) 
X64116:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
Doomsday4:add_int_range("◀ Player 1", 1.0, 15, 313, function() return globals.get_int(CP1Do) end, function(value) globals.set_int(CP1Do, value) end) 
Doomsday4:add_int_range("◀ Player 2", 1.0, 15, 313, function() return globals.get_int(CP2Do) end, function(value) globals.set_int(CP2Do, value) end)
Doomsday4:add_int_range("◀ Player 3", 1.0, 15, 313, function() return globals.get_int(CP3Do) end, function(value) globals.set_int(CP3Do, value) end) 
Doomsday4:add_int_range("◀ Player 4", 1.0, 15, 313, function() return globals.get_int(CP4Do) end, function(value) globals.set_int(CP4Do, value) end)

Doomsday4:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
Doomsday4:add_action("◀ All 200", function() for i = CP1Do, CP4Do do globals.set_int(i, 200) end end)
Doomsday4:add_action("◀ All 175", function() for i = CP1Do, CP4Do do globals.set_int(i, 175) end end)
Doomsday4:add_action("◀ All 150", function() for i = CP1Do, CP4Do do globals.set_int(i, 150) end end)
Doomsday4:add_action("◀ All 125", function() for i = CP1Do, CP4Do do globals.set_int(i, 125) end end)
Doomsday4:add_action("◀ All 100", function() for i = CP1Do, CP4Do do globals.set_int(i, 100) end end)
Doomsday4:add_action("◀ All 75", function() for i = CP1Do, CP4Do do globals.set_int(i, 75) end end)
Doomsday4:add_action("◀ All 50", function() for i = CP1Do, CP4Do do globals.set_int(i, 50) end end)
Doomsday4:add_action("◀ All 25", function() for i = CP1Do, CP4Do do globals.set_int(i, 25) end end)
Doomsday4:add_action("◀ All 0", function() for i = CP1Do, CP4Do do globals.set_int(i, 0) end end)
Doomsday4:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
globals.set_int(CP1Do, 209) globals.set_int(CP2Do, 209)
globals.set_int(CP3Do, 209) globals.set_int(CP4Do, 209) elseif value == 2 then 
globals.set_int(CP1Do, 143) globals.set_int(CP2Do, 143) 
globals.set_int(CP3Do, 143) globals.set_int(CP4Do, 143) elseif value == 3 then 
globals.set_int(CP1Do, 113) globals.set_int(CP2Do, 113) 
globals.set_int(CP3Do, 113) globals.set_int(CP4Do, 113) end xox_23 = value end)
...
Heists044577:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
Heists044577:add_action("◀◀ Skip Crack Casino Fingerprint", function() if fmC and fmC:is_active() then if fmC:get_int(R019) == 4 then fmC:set_int(R019, 5) end end end)
Heists044577:add_action("◀◀ Quick Drill Vault Door", function() if fmC:is_active() then fmC:set_int(R020, 4) sleep(0.01) fmC:set_int(R020, 6) menu.send_key_press(1) end end)
Heists044577:add_action("◀◀ Bypass Door Hack ", function() if fmC and fmC:is_active() then if fmC:get_int(R021) ~= 4 then fmC:set_int(R021, 5) end end end)
Heists044577:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
Heists044:add_int_range("◀ Player 1", 5, 15, 300, function() return globals.get_int(CP1Di) end, function(value) globals.set_int(CP1Di, value) end) 
Heists044:add_int_range("◀ Player 2", 5, 15, 300, function() return globals.get_int(CP2Di) end, function(value) globals.set_int(CP2Di, value) end)
Heists044:add_int_range("◀ Player 3", 5, 15, 300, function() return globals.get_int(CP3Di) end, function(value) globals.set_int(CP3Di, value) end) 
Heists044:add_int_range("◀ Player 4", 5, 15, 300, function() return globals.get_int(CP4Di) end, function(value) globals.set_int(CP4Di, value) end) 

Heists044:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
Heists044:add_action("◀ All 200", function() for i = CP1Di, CP4Di do globals.set_int(i, 200) end end)
Heists044:add_action("◀ All 179", function() for i = CP1Di, CP4Di do globals.set_int(i, 179) end end)
Heists044:add_action("◀ All 150", function() for i = CP1Di, CP4Di do globals.set_int(i, 150) end end)
Heists044:add_action("◀ All 125", function() for i = CP1Di, CP4Di do globals.set_int(i, 125) end end)
Heists044:add_action("◀ All 100", function() for i = CP1Di, CP4Di do globals.set_int(i, 100) end end)
Heists044:add_action("◀ All 75", function() for i = CP1Di, CP4Di do globals.set_int(i, 75) end end)
Heists044:add_action("◀ All 50", function() for i = CP1Di, CP4Di do globals.set_int(i, 50) end end)
Heists044:add_action("◀ All 25", function() for i = CP1Di, CP4Di do globals.set_int(i, 25) end end)
Heists044:add_action("◀ All 0", function() for i = CP1Di, CP4Di do globals.set_int(i, 0) end end)
Heists044:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
Casinox5588:add_action("◀◀ Quick Plasma Cutter", function() IF0A:set_float(R023, 100) end)
Casinox5588:add_action("◀◀ Bypass Fingerprint Hack", function() IF0A:set_int(R024, 5) end)
IF0A = script("fm_mission_controller_2020")
		local function Pad2()
			IF0A:set_int(R023, 5)
			IF0A:set_int(R024, 6)
		end
...
Casinox5588:add_int_range("◀◀ Cayo Bag Size", 900.0, 1800, 999999999, function() return 
globals.get_int(262145 + R025) end, function(value) 
globals.set_int(262145 + R026, value) end) 
...
Casinox56:add_int_range("◀ Player 1", 1, 15, 300, function() return globals.get_int(CP1Ca) end, function(value) globals.set_int(CP1Ca, value) end) 
Casinox56:add_int_range("◀ Player 2", 1, 15, 300, function() return globals.get_int(CP2Ca) end, function(value) globals.set_int(CP2Ca, value) end) 
Casinox56:add_int_range("◀ Player 3", 1, 15, 300, function() return globals.get_int(CP3Ca) end, function(value) globals.set_int(CP3Ca, value) end) 
Casinox56:add_int_range("◀ Player 4", 1, 15, 300, function() return globals.get_int(CP4Ca) end, function(value) globals.set_int(CP4Ca, value) end) 

Casinox56:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)

Casinox56:add_action("All 120", function() for i = CP1Ca, CP4Ca  do globals.set_int(i, 120) end end)
Casinox56:add_action("All 100", function() for i = CP1Ca, CP4Ca  do globals.set_int(i, 100) end end)
Casinox56:add_action("All 75", function() for i = CP1Ca, CP4Ca  do globals.set_int(i, 75) end end)
Casinox56:add_action("All 50", function() for i = CP1Ca, CP4Ca  do globals.set_int(i, 50) end end)
Casinox56:add_action("All 25", function() for i = CP1Ca, CP4Ca  do globals.set_int(i, 25) end end)
Casinox56:add_action("All 0", function() for i = CP1Ca, CP4Ca  do globals.set_int(i, 0) end end)
...
Finish:add_action("- Auto Shop / Heist Cayo Perlco  ", function() end)

RecoveryP1 = "fm_mission_controller_2020"
Finish:add_action("           ◀◀ Instant Passed (1) ◀◀", function()
   if(script(RecoveryP1):is_active()) then
	   script(RecoveryP1):set_int(InsR1, 51338752)
	   script(RecoveryP1):set_int(InsR2, 50)
   end
end)
...
Finish:add_action("           ◀◀ Instant Passed (2) ◀◀", function()
   if(script(RecoveryP2):is_active()) then
	   script(RecoveryP2):set_int(InsR3, 80)
	   script(RecoveryP2):set_int(InsR4, 10000000)
	   script(RecoveryP2):set_int(InsR5, 99999)
	   script(RecoveryP2):set_int(InsR6, 99999)
   end
end)
...
Finish:add_action("        ◀◀ Instant Heist Passed (3) ◀◀", function()
   if(script(RecoveryP2):is_active()) then
	   script(RecoveryP2):set_int(InsR7, 12)
	   script(RecoveryP2):set_int(InsR8, 150)
	   script(RecoveryP2):set_int(InsR9, 99999)
	   script(RecoveryP2):set_int(InsR10, 99999)
	   script(RecoveryP2):set_int(InsR611, 80)
   end
end)
Finish:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
Finish:add_action("          ◀◀ Instant Sightseer (4) ◀◀", function()
	...
	script(Insta):set_int(VIPS + 1 , 6) 
	 script(Insta):set_int(VIPS + 1 , 5)
	 script(Insta):set_int(VIPS + 1 , 3)
end 
end)
...
local function Activity(bool) globals.set_bool(1683531+584, bool) end
local function Bounty(bool) globals.set_bool(1683531+65, bool) end
local function CeoKick(bool) globals.set_bool(1683531+556, bool) end
...
local function getKickCrashesState() return ( globals.get_bool(1683531+753) and
...
local function CeoBan(bool)globals.set_bool(1683531+578, bool) 
end
...
local function InfiniteLoad(bool) globals.set_bool(1683531+579, bool) globals.set_bool(1683531+648, bool) end
...
local function PassiveMode(bool) globals.set_bool(1683531+568, bool) end
local function TransactionError(bool) globals.set_bool(1683531+369, bool) end
...
ProtectionB:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
ProtectionB:add_toggle("◀ Block Start Activity", function() return globals.get_bool(1683531+584) end, function() Block(not globals.get_bool(1683531+584)) end)
ProtectionB:add_toggle("◀ Block Bounty", function() return globals.get_bool(1683531+65) end, function() Bounty(not globals.get_bool(1683531+65)) end)
ProtectionB:add_toggle("◀ Block Ceo Kick", function() return globals.get_bool(1683531+556) end, function() CeoKick(not globals.get_bool(1683531+556)) end)
ProtectionB:add_toggle("◀ Block Ceo Ban", function() return globals.get_bool(1683531+578) end, function() CeoBan(not globals.get_bool(1683531+578)) end)
...
ProtectionB:add_toggle("◀ Block Passive Mode", function() return globals.get_bool(1683531+568) end, function() PassiveMode(not globals.get_bool(1683531+568)) end)
ProtectionB:add_toggle("◀ Block Transaction Error", function() return globals.get_bool(1683531+369)end, function()TransactionError(not globals.get_bool(1683531+369))end)
...
ProtectionB:add_toggle("◀ Block Clear Wanted", function() return globals.get_bool(1683531+510) end, function() ClearWanted(not globals.get_bool(1683531+510)) end)
ProtectionB:add_toggle("◀ Block Off The Radar", function() return globals.get_bool(1683531+512) end, function() OffTheRadar(not globals.get_bool(1683531+512)) end)
...
ProtectionB:add_toggle("◀ Block Send to Cutscene", function() return globals.get_bool(1683531+805) end, function() SendCutscene(not globals.get_bool(1683531+805))end)
ProtectionB:add_toggle("◀ Block Remove Godmode", function()return globals.get_bool(1683531+2) end, function() Godmode(not globals.get_bool(1683531+2))end)
ProtectionB:add_toggle("◀ Block Give Collectibles", function() return globals.get_bool(1683531+815) end, function() Collectibles(not globals.get_bool(1683531+815)) end)
...
globals.set_int(1961347, 1) sleep(3)
globals.set_int(1961347, 0) sleep(30) end end
...
globals.set_int(1961347, 2)sleep(3)
globals.set_int(1961347, 0) sleep(30) end end
...
globals.set_int(1961347, 2) sleep(3)
globals.set_int(1961347, 0) sleep(3)
globals.set_int(1961347, 2) sleep(3)
globals.set_int(1961347, 0) sleep(60) end end
...
globals.set_int(1961347, 0) sleep(3)
globals.set_int(1961347, 2) sleep(3) 
globals.set_int(1961347, 0) sleep(120)  end end
...
NightclubCargo:add_int_range("◀ Sporting Goods", 5000, 5000, 4000000, function() return globals.get_int(262145 + R053) end, function(value) globals.set_int(262145 + R053, value) end) 
NightclubCargo:add_int_range("◀ South American Imports ", 10000, 27000, 4000000, function() return globals.get_int(262145 + R054) end, function(value) globals.set_int(262145 + R054, value) end)  
NightclubCargo:add_int_range("◀ Pharmaceutical Research", 10000, 11475, 4000000, function() return globals.get_int(262145 + R055) end, function(value) globals.set_int(262145 + R055, value) end) 
NightclubCargo:add_int_range("◀ Organic Produce ", 10000, 2025, 4000000, function() return globals.get_int(262145 + R056) end, function(value) globals.set_int(262145 + R056, value) end)  
NightclubCargo:add_int_range("◀ Printing - Copying ", 10000, 1350, 4000000, function() return globals.get_int(262145 + R057) end, function(value) globals.set_int(262145 + R057, value) end) 
NightclubCargo:add_int_range("◀ Cash Creation", 10000, 4725, 4000000, function() return globals.get_int(262145 + R058) end, function(value) globals.set_int(262145 + R058, value) end) 
NightclubCargo:add_int_range("◀ Gargo - Shipments", 10000, 10000, 4000000, function() return globals.get_int(262145 + R059) end, function(value) globals.set_int(262145 + R059, value) end)
NightclubCargo:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
Speciaal:add_action("◀◀ Set Cargo +100k", function()
	...
	globals.set_int(262145+R068+3, Recoverys//5)
	globals.set_int(262145+R068+4, Recoverys//7)
	globals.set_int(262145+R068+5, Recoverys//9) 
	globals.set_int(262145+R068+6, Recoverys//14)
	globals.set_int(262145+R068+7, Recoverys//19)
	globals.set_int(262145+R068+8, Recoverys//24)
	globals.set_int(262145+R068+9, Recoverys//29)
	globals.set_int(262145+R068+10, Recoverys//34)
	globals.set_int(262145+R068+11, Recoverys//39)
	globals.set_int(262145+R068+12, Recoverys//44)
	globals.set_int(262145+R068+13, Recoverys//49)
	globals.set_int(262145+R068+14, Recoverys//59)
	globals.set_int(262145+R068+15, Recoverys//69)
	globals.set_int(262145+R068+16, Recoverys//79)
	globals.set_int(262145+R068+17, Recoverys//89)
	globals.set_int(262145+R068+18, Recoverys//99)
	globals.set_int(262145+R068+19, Recoverys//110)
	globals.set_int(262145+R068+20, Recoverys//111)
end)
...
Speciaal:add_action("◀◀ Set Cargo +5M", function()
    Recoverys = 5000000
    globals.set_int(262145+R068, Recoverys//1)globals.set_int(262145+R068+1, Recoverys//2)globals.set_int(262145+R068+2, Recoverys//3)globals.set_int(262145+R068+3, Recoverys//5)globals.set_int(262145+R068+4, Recoverys//7)globals.set_int(262145+R068+5, Recoverys//9)globals.set_int(262145+R068+6, Recoverys//14)globals.set_int(262145+R068+7, Recoverys//19)globals.set_int(262145+R068+8, Recoverys//24)globals.set_int(262145+R068+9, Recoverys//29)globals.set_int(262145+R068+10, Recoverys//34) globals.set_int(262145+R068+11, Recoverys//39)globals.set_int(262145+R068+12, Recoverys//44)globals.set_int(262145+R068+13, Recoverys//49)globals.set_int(262145+R068+14, Recoverys//59)globals.set_int(262145+R068+15, Recoverys//69)globals.set_int(262145+R068+16, Recoverys//79)globals.set_int(262145+R068+17, Recoverys//89)globals.set_int(262145+R068+18, Recoverys//99)globals.set_int(262145+R068+19, Recoverys//110)globals.set_int(262145+R068+20, Recoverys//111)
end)
Speciaal:add_action("◀◀ Set Cargo +6M", function()
    Recoverys = 6000000
    globals.set_int(262145+R068, Recoverys//1)globals.set_int(262145+R068+1, Recoverys//2)globals.set_int(262145+R068+2, Recoverys//3)globals.set_int(262145+R068+3, Recoverys//5)globals.set_int(262145+R068+4, Recoverys//7)globals.set_int(262145+R068+5, Recoverys//9)globals.set_int(262145+R068+6, Recoverys//14)globals.set_int(262145+R068+7, Recoverys//19)globals.set_int(262145+R068+8, Recoverys//24)globals.set_int(262145+R068+9, Recoverys//29)globals.set_int(262145+R068+10, Recoverys//34)globals.set_int(262145+R068+11, Recoverys//39)globals.set_int(262145+R068+12, Recoverys//44)globals.set_int(262145+R068+13, Recoverys//49)globals.set_int(262145+R068+14, Recoverys//59)globals.set_int(262145+R068+15, Recoverys//69)globals.set_int(262145+R068+16, Recoverys//79)globals.set_int(262145+R068+17, Recoverys//89)globals.set_int(262145+R068+18, Recoverys//99)globals.set_int(262145+R068+19, Recoverys//110)globals.set_int(262145+R068+20, Recoverys//111)
end)
Speciaal:add_action("◀◀ Set Cargo +7M", function()
    Recoverys = 7000000
    globals.set_int(262145+R068, Recoverys//1)globals.set_int(262145+R068+1, Recoverys//2)globals.set_int(262145+R068+2, Recoverys//3)globals.set_int(262145+R068+3, Recoverys//5)globals.set_int(262145+R068+4, Recoverys//7)globals.set_int(262145+R068+5, Recoverys//9)globals.set_int(262145+R068+6, Recoverys//14)globals.set_int(262145+R068+7, Recoverys//19)globals.set_int(262145+R068+8, Recoverys//24)globals.set_int(262145+R068+9, Recoverys//29)globals.set_int(262145+R068+10, Recoverys//34)globals.set_int(262145+R068+11, Recoverys//39)globals.set_int(262145+R068+12, Recoverys//44)globals.set_int(262145+R068+13, Recoverys//49)globals.set_int(262145+R068+14, Recoverys//59)globals.set_int(262145+R068+15, Recoverys//69)globals.set_int(262145+R068+16, Recoverys//79)globals.set_int(262145+R068+17, Recoverys//89)globals.set_int(262145+R068+18, Recoverys//99)globals.set_int(262145+R068+19, Recoverys//110) globals.set_int(262145+R068+20, Recoverys//111)
end)
Speciaal:add_action("◀◀ Set Cargo +8M", function()
    Recoverys = 8000000
    globals.set_int(262145+R068, Recoverys//1)globals.set_int(262145+R068+1, Recoverys//2)globals.set_int(262145+R068+2, Recoverys//3)globals.set_int(262145+R068+3, Recoverys//5)globals.set_int(262145+R068+4, Recoverys//7)globals.set_int(262145+R068+5, Recoverys//9)globals.set_int(262145+R068+6, Recoverys//14)globals.set_int(262145+R068+7, Recoverys//19)globals.set_int(262145+R068+8, Recoverys//24)globals.set_int(262145+R068+9, Recoverys//29)globals.set_int(262145+R068+10, Recoverys//34)globals.set_int(262145+R068+11, Recoverys//39)globals.set_int(262145+R068+12, Recoverys//44)globals.set_int(262145+R068+13, Recoverys//49)globals.set_int(262145+R068+14, Recoverys//59)globals.set_int(262145+R068+15, Recoverys//69)globals.set_int(262145+R068+16, Recoverys//79)globals.set_int(262145+R068+17, Recoverys//89)globals.set_int(262145+R068+18, Recoverys//99)globals.set_int(262145+R068+19, Recoverys//110)globals.set_int(262145+R068+20, Recoverys//111)
end)
Speciaal:add_action("◀◀ Set Cargo +9M", function()
    Recoverys = 9000000
    globals.set_int(262145+R068, Recoverys//1)globals.set_int(262145+R068+1, Recoverys//2)globals.set_int(262145+R068+2, Recoverys//3)globals.set_int(262145+R068+3, Recoverys//5)globals.set_int(262145+R068+4, Recoverys//7)globals.set_int(262145+R068+5, Recoverys//9)globals.set_int(262145+R068+6, Recoverys//14)globals.set_int(262145+R068+7, Recoverys//19)globals.set_int(262145+R068+8, Recoverys//24)globals.set_int(262145+R068+9, Recoverys//29)globals.set_int(262145+R068+10, Recoverys//34)globals.set_int(262145+R068+11, Recoverys//39)globals.set_int(262145+R068+12, Recoverys//44)globals.set_int(262145+R068+13, Recoverys//49)globals.set_int(262145+R068+14, Recoverys//59)globals.set_int(262145+R068+15, Recoverys//69)globals.set_int(262145+R068+16, Recoverys//79)globals.set_int(262145+R068+17, Recoverys//89)globals.set_int(262145+R068+18, Recoverys//99)globals.set_int(262145+R068+19, Recoverys//110)globals.set_int(262145+R068+20, Recoverys//111)
end)
Speciaal:add_action("◀◀ Set Cargo +10M", function()
    Recoverys = 10000000
    globals.set_int(262145+R068, Recoverys//1)globals.set_int(262145+R068+1, Recoverys//2)globals.set_int(262145+R068+2, Recoverys//3)globals.set_int(262145+R068+3, Recoverys//5)globals.set_int(262145+R068+4, Recoverys//7) globals.set_int(262145+R068+5, Recoverys//9)globals.set_int(262145+R068+6, Recoverys//14)globals.set_int(262145+R068+7, Recoverys//19)globals.set_int(262145+R068+8, Recoverys//24)globals.set_int(262145+R068+9, Recoverys//29)globals.set_int(262145+R068+10, Recoverys//34)globals.set_int(262145+R068+11, Recoverys//39)globals.set_int(262145+R068+12, Recoverys//44)globals.set_int(262145+R068+13, Recoverys//49)globals.set_int(262145+R068+14, Recoverys//59)globals.set_int(262145+R068+15, Recoverys//69)globals.set_int(262145+R068+16, Recoverys//79)globals.set_int(262145+R068+17, Recoverys//89)globals.set_int(262145+R068+18, Recoverys//99)globals.set_int(262145+R068+19, Recoverys//110)globals.set_int(262145+R068+20, Recoverys//111)
end)
...
CargoSell:add_action("◀◀ Remove Buy Cooldown", function()
	globals.set_int(262145+R070, 0) 
end)
CargoSell:add_action("◀◀ Remove Sell Cooldown", function()
	globals.set_int(262145+R071, 0) 
end)
...
AcidLab:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
AcidLab:add_action("◀◀ Resupply Goods ",function()globals.set_int(1662873+7,1)end)
AcidLab:add_action("◀◀ Acid Lab Equipment Upgrade",function() stats.set_int(MPX .. "AWD_CALLME", 10) end)
AcidLab:add_int_range("◀ Set Money Acid ", 600.0, 500, 50000, function()return globals.get_int(262145 + R072)end, function(value)globals.set_int(262145 + R072, value)end)	
AcidLab:add_int_range("◀ Set Bost Acid Lab", 1.0, 0, 1, function() return globals.get_int(262145 + R073)end, function(value)globals.set_int(262145 + R073, value) end)
AcidLab:add_action("ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ", function() end)
...
BIKERMR:add_action("◀◀ Resupply ( Document Forgery Cash )", function() globals.set_int(Mcash, 1) end)
Mcash = 1662873 + 1 
BIKERMR:add_action("◀◀ Resupply ( Counterfeit Cash )", function() globals.set_int(Mcoke, 2) end)
Mcoke = 1662873 + 2
BIKERMR:add_action("◀◀ Resupply ( Weed Farm )", function() globals.set_int(MWeed, 3) end)
MWeed = 1662873 + 3
BIKERMR:add_action("◀◀ Resupply ( Meth Lab )", function() globals.set_int(MMeth, 4) end)
MMeth = 1662873 + 4 
BIKERMR:add_action("◀◀ Resupply ( Cocaube Lockup )", function() globals.set_int(Mdocuments, 5) end)
...
World:add_toggle("◀◀ Get Rc Bandito ", function() return globals.get_boolean(2738587+R087) end,  function(value) globals.set_boolean(2738587+R087,value) end)
World:add_toggle("◀◀ Get Rc Tank  ", function() return globals.get_boolean(2738587+R088) end,  function(value) globals.set_boolean(2738587+R088,value) end)
